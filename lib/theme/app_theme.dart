...
/// Implements Clinical Minimalism design style with Medical Trust Palette.
class AppTheme {
  AppTheme._();

  // Medical Trust Palette - Healthcare optimized colors
  static const Color primaryLight = Color(0xFF2B5CE6); // Medical trust blue
  static const Color primaryVariantLight = Color(0xFF1E4BD1);
  static const Color secondaryLight = Color(0xFF00A86B); // Healthcare green
  static const Color secondaryVariantLight = Color(0xFF008A57);
  static const Color accentLight = Color(0xFFFF6B35); // Emergency orange
  static const Color backgroundLight = Color(0xFFFAFBFC); // Soft neutral
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color errorLight = Color(0xFFE53E3E); // Clear error
  static const Color warningLight = Color(0xFFF6AD55); // Appointment warnings
  static const Color successLight = Color(0xFF38A169); // Positive indicators
  static const Color textPrimaryLight = Color(0xFF1A202C); // High contrast
  static const Color textSecondaryLight = Color(0xFF718096); // Supporting info

  // Dark theme variants
  static const Color primaryDark = Color(0xFF4C7BF7);
  static const Color primaryVariantDark = Color(0xFF2B5CE6);
  static const Color secondaryDark = Color(0xFF00C878);
  static const Color secondaryVariantDark = Color(0xFF00A86B);
  ...
  static const Color successDark = Color(0xFF4FD1C7);
  ...
  // Shadow colors - Subtle elevation for Clinical Minimalism
  static const Color shadowLight = Color(0x0A000000);
  static const Color shadowDark = Color(0x1A000000);

  // Divider colors - Minimal borders
  static const Color dividerLight = Color(0x1A2B5CE6); // 20% opacity primary
  static const Color dividerDark = Color(0x1A4C7BF7);

  // Text emphasis levels for accessibility
  static const Color textHighEmphasisLight = Color(0xFF1A202C);
  static const Color textMediumEmphasisLight = Color(0xFF4A5568);
  static const Color textDisabledLight = Color(0xFFA0AEC0);

  static const Color textHighEmphasisDark = Color(0xFFF7FAFC);
  static const Color textMediumEmphasisDark = Color(0xFFE2E8F0);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for healthcare professionalism
    ...
    // Bottom navigation for healthcare app structure
